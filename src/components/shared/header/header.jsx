    ...
    <header className={style.header}>
        ...
        <div className={style.container}>
            <nav className="nav">
              <ul className="nav__list">
                {props.state.nav.map(el => <li className={'nav__item ' + el.anotherClass} key={el.id}>{el.name}</li>)}
              </ul>
            </nav>
      ...
      <div className="header__bottom" key='lol'>
        <div className="container">
          ...
          <ul className="menu">
            {props.state.menu.map(el => <li className={'menu__item ' + el.anotherClass} key={el.id}>{el.name}</li>)}
          </ul>
